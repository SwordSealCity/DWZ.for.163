function initEnv() {
	...
	setTimeout(function(){
		...
		if(isNewTab !== -1 && _newUrl !== ''){
			...
			navTab.openTab(_newUrl, _newUrl);
		}
	}, 10);
...
function initLayout(){
	...
	// 调整编辑页面的dl.nowrap标签宽度 --Aramey 2014.1.10
	var ddWidth = $("dl.nowrap").width() - $("dl.nowrap").find('dt').outerWidth(true) - 20;
	$("dl.nowrap").find('dd').width(ddWidth);
}
