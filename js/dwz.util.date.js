...
Date.prototype.formatDate = function(dateFmt) {
	//console.log('timer:'+this+',Fmt:'+dateFmt);
	return formatDate(this, dateFmt);
};

// '2014年1月22日 15点'.parseDate('y年M月d日 H点');
// '2013-12-19 15:15:12'.parseDate('yyyy-MM-dd HH:mm:ss');
// '2000-01-01'.parseDate('y-M-d');
...
// '\/Date(1388114293895)\/'.transTime('y年M月d日 HH:mm:ss');
// 参考'日期控件'页面模式，this.substring(6)是为删除前面的 \/Date字符
String.prototype.transDate = function(dateFmt){
	//console.log(new Date(parseInt(this.substring(6))));
