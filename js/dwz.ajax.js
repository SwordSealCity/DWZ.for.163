...
function iframeCallback(form, callback){
	...
	/** 最新跨域解决方法 2014.1.15  ---- Aramey**/
	/*
	if($.browser.msie){
		var ifmCallback=document.createElement('iframe');
		ifmCallback.src="about:blank";
		ifmCallback.id="callbackframe";
		ifmCallback.name="callbackframe";
		ifmCallback.style.display="none";
		document.body.appendChild(ifmCallback);
		try{
			ifmCallback.contentWindow.document.title;
		}catch(e){
			$("#callbackframe").load(function(){ifmCallback.onload = null;});
			ifmCallback.src="javascript:void((function(){var d=document;d.open();d.domain='"+document.domain+"';d.write(' ');d.close()})())";
